                    ...
                    <div class="">
                        ...
                        <div class="row mg-b-20">
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                ...
                                <select name="add" id="select-beast" class="form-control  nice-select  custom-select">
                        ...
                        <div class="row mg-b-20">
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                ...
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" name="ssn" required="" type="text" value="{{ old('ssn') }}">
                            </div>
                        </div>
