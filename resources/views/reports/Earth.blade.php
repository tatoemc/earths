            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="col-sm-1 col-md-2">
                        <a class="btn btn-primary btn-sm" href="{{route('reports.index')}}">رجوع </a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: right;">
                            ...
                            <tbody>
                              @foreach ($enumbers as $enumber)
                                <tr>
                                   <td>{{ $enumber->name }}</td>
                                   <td>{{ $enumber->enumber}}</td>
                                    <td>{{ $enumber->square->name }}</td>
                                   <td>{{ $enumber->space  }}</td>
									<td><a href="{{ route('earths.show', $enumber->id) }}"><i class="text-success fas fa-eye"></i>&nbsp;&nbsp;عرض  </a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
